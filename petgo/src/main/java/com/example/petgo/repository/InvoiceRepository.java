...
public interface InvoiceRepository extends JpaRepository<Invoice, Long> {
    ...
    @EntityGraph(attributePaths = {"user", "booking", "booking.provider", "booking.pet", "booking.providerService", "booking.providerService.service", "membershipSubscription", "membershipSubscription.membershipPlan"})
