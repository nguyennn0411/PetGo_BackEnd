...
public class AdminController {
    ...
    public ResponseEntity<Map<String, Object>> updateProviderAccountStatus(@RequestBody ProviderVerificationRequest request) {
    ...
    public ResponseEntity<Map<String, Object>> createCategory(@RequestBody com.example.petgo.dto.ServiceCategoryRequest request) {
        return ResponseEntity.ok(Map.of(
    ...
    public ResponseEntity<Map<String, Object>> updateCategory(@PathVariable Long id, @RequestBody com.example.petgo.dto.ServiceCategoryRequest request) {
        return ResponseEntity.ok(Map.of(
