...
public class ProviderDiscoveryController {
    ...
    public ResponseEntity<ProviderListResponse> getProviders(
            ...
            @RequestParam(required = false) String serviceCategorySlugs,
        ...
        return ResponseEntity.ok(providerDiscoveryService.findProviders(buildCriteria(
                query, city, serviceCategorySlugs, minPrice, maxPrice, minRating,
    ...
    private ProviderSearchCriteria buildCriteria(
        ...
        List<String> categorySlugs = parseCsv(serviceCategorySlugs);
        return ProviderSearchCriteria.builder()
                .query(query)
                .city(city)
                .serviceCategorySlugs(categorySlugs)
                .minPrice(minPrice)
                .maxPrice(maxPrice)
                .minRating(minRating)
                .latitude(latitude)
